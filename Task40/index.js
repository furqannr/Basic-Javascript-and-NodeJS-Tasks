...
value for the number of tracks, add that value to the album’s Object. Make at least one new function 
...
console.log(make_album("Junaid Jamshaid","Mein Madinay chala"));
console.log(make_album("Atif Aslam","Tum bin","08"));
console.log(make_album("Imtiaz Alam","Tu Kon"));
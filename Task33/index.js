...
for (let index = 0; index < ordinalNum.length; index++) {   
if (ordinalNum[index]==1)
{
    console.log(ordinalNum[index]+ 'st');
}
else if (ordinalNum[index]==2)
{
    console.log(ordinalNum[index]+ 'nd');
}
else if (ordinalNum[index]==3)
{
    console.log(ordinalNum[index]+ 'rd');
}
else
{
    console.log(ordinalNum[index]+ 'th');
}
}
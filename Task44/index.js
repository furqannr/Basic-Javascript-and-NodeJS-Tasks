...
function make_sandwich(...sandwich_items) {
   ...
   for (let index = 0; index < sandwich_items.length; index++) {
    console.log(sandwich_items[index]+" has been added to sandwich");
    }
   
}


make_sandwich("cheese", "chciken");
console.log("Your sandwich is ready...\n\n");
make_sandwich("cheese","chciken","onion");
console.log("Your sandwich is ready...\n\n");
make_sandwich("cheese","chciken","onion","tomato");
console.log("Your sandwich is ready...\n\n");
